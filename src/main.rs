...
fn main() {
    ...
    let run1 = Run {
        ...
        stages: vec![
            EnvironmentId::TitanicPlains,
            EnvironmentId::AbandonedAqueduct,
            EnvironmentId::SulfurPools,
            EnvironmentId::SunderedGrove,
            EnvironmentId::SkyMeadow,
        ],
        clock_at_stage: vec![
            min_sec(14, 25),
            min_sec(33, 36),
        ...
        scaling_at_stage: vec![10, 22, 34, 53],
    };
...
pub fn min_sec(minutes: i64, seconds: i64) -> Duration {
